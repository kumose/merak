...
#ifndef MERAK_JSON_DTOA_
#define MERAK_JSON_DTOA_
...
MERAK_JSON_DIAG_OFF(array-bounds) // some gcc versions generate wrong warnings https://gcc.gnu.org/bugzilla/show_bug.cgi?id=59124
#endif
...
inline char* dtoa(double value, char* buffer, int maxDecimalPlaces = 324) {
    MERAK_JSON_ASSERT(maxDecimalPlaces >= 1);
    Double d(value);
    if (d.IsZero()) {
        if (d.Sign())
